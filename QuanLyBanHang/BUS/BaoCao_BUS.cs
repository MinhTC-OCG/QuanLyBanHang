    ...
    public class BaoCao_BUS
    {
        ...
        public DataTable GetReport(string ngaylap)
        {
            string sql = "SELECT Hang12.MaH,Hang12.TenH,Hang12.DonVT,Hang12.DonG," +
                ...
                "FROM Hang12 INNER JOIN HoaDonChiTiet12 ON Hang12.MaH = HoaDonChiTiet12.MaH INNER JOIN HoaDon12 " +
                "ON HoaDonChiTiet12.MaHD = HoaDon12.MaHD WHERE NgayLap ='"+ngaylap+"' GROUP BY Hang12.MaH, Hang12.TenH,Hang12.DonVT,Hang12.DonG";
