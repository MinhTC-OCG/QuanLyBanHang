...
namespace GUI
{
    public partial class NhaCungCap : Form
    {
        ...
        private void bnThem_Click(object sender, EventArgs e){
            try{
                if (txtMaNCC.Text == "")MessageBox.Show("Bạn chưa nhập mã nhà cung cấp, nhập lại!");
                else if (txtTenNCC.Text == "")MessageBox.Show("Bạn chưa nhập tên nhà cung cấp, nhập lại!");
                    ...
                    if (dem == 0){
                        ...
                        LoadData();
                    }else{MessageBox.Show("Mã nhà cung cấp đã tồn tại, nhập lại!", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);}
                }}
            catch (Exception){ MessageBox.Show("Không thêm được nhà cung cấp, thử lại!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);}
        }
        ...
        private void bnSua_Click(object sender, EventArgs e){
            try{
                if (txtMaNCC.Text == "")MessageBox.Show("Bạn chưa nhập mã Nhà cung cấp, nhập lại!");
                    ...
                    }else{MessageBox.Show("Mã nhà cung cấp không tồn tại, nhập lại!", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);}
                }}
            catch (Exception){MessageBox.Show("Không cập nhật được nhà cung cấp, thử lại!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);}
        }
